...
public abstract class SmartWatch {
    //we can have instance variables,access modifiers,constructor in an abstract class
    private int RAM;
    protected int ROM;
    double displaySize;
    public String make;
    ...
    public void updateOS() {
        checkOSUpdate();//calling one method inside another
        downloadUpdate();
        installUpdate();
        System.out.println("Updating the OS");
    }

    private void checkOSUpdate() {//dividing the update into smaller part, so we can maintain and make changes easily
