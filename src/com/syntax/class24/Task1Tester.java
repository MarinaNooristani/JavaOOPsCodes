...
public class Task1Tester {
    public static void main(String[] args) {
        ...
        Student syntaxStudent = new SyntaxStudent();//Student as type for syntaxstudent
        Student schoolStudent = new SchoolStudent();//upcasting
      /*
       ...
       */
        Student[] students = {new SyntaxStudent(), new SchoolStudent(),
                new CollegeStudent()};//index 0, index 1, index 2
   /*  int[] arr={1,2,3};
        for (int number:arr
             ) {
